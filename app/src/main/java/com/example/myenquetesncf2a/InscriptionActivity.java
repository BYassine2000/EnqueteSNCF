...
public class InscriptionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //creation d'un adaptateur pour l'affichage du spinner
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.Valider)
        {
            ...
            if (nom.equals("")) {
                Toast.makeText(this, "Veuillez saisir le nom du Candidat",
                        Toast.LENGTH_LONG).show();
            }

            if (prenom.equals("")) {
                Toast.makeText(this, "Veuillez saisir le prénom du Candidat",
                        Toast.LENGTH_LONG).show();
            }
            if (email.equals("")) {
                Toast.makeText(this, "Veuillez saisir l'email du Candidat",
                        Toast.LENGTH_LONG).show();
            }

            if (!nom.equals("") && !prenom.equals("") && !email.equals("")) {
                // Instanciation de la classe Candidat à l'enquête
            ...
            //Ajouter le candidat dans la HashMap de l'enquete,identifiée par le rer
                if (!SNCF.getEnquete(rer).ajouterCandidat(unCandidat)) {
                    Toast.makeText(this, "Candidat a déjà partipé",
                            Toast.LENGTH_LONG).show();
                } else {
                    unIntent.putExtra("rer", rer);
                    unIntent.putExtra("email", email);
                    Toast.makeText(this, "Bienvenue "+nom+" "+prenom,
                            Toast.LENGTH_LONG).show();
